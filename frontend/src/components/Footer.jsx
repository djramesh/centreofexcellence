        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            <div className="footer-logos">
              <div className="f-logo-wrap f-logo-light">
                <img src="./assets/ph-logo.png" alt="Prerana Handloom" />
              </div>
              <div className="f-logo-wrap f-logo-dark">
                <img src="./assets/logo-2.png" alt="Shristi Handicraft" />
              </div>
            </div>
            <p className="footer-tagline">
              Handcrafted with tradition.<br />Designed for today.
            </p>
            <div className="footer-socials">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/916001773030" className="f-social" aria-label="WhatsApp">
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          ...
          {/* About */}
          <div className="footer-col">
            <h5 className="footer-col-title">Our Societies</h5>
            <ul className="footer-links">
              <li><Link to="/shristi-handicraft">Shristi Handicraft</Link></li>
              <li><Link to="/prerana-handloom">Prerana Handloom</Link></li>
              <li><Link to="/oirds">OIRDS</Link></li>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-contact-list">
              <li>
                ...
                <span>Tipling, Duliajan<br />Dibrugarh, Assam 786602</span>
              </li>
              <li>
              ...
              <li>
                <span className="f-contact-icon">📞</span>
                <span>
                  <a href="tel:+916001773030">+91 60017 73030</a><br />
                  <a href="tel:+917002301360">+91 70023 01360</a>
                </span>
              </li>
            </ul>
          </div>
